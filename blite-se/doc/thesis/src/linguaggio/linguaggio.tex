...
rispetto alla diverse istanze. Vedremo come la semantica di Blite definisca tale
...
\begin{itemize}
  ...
  contesti falliti con i rispettivi compesation handler eseguiti in maniera
...
di individuare un sott'insieme fra tutti i tipi di attività presenti nel
...
tramite due relazioni di riduzione, una che descrive l'evoluzione delle istanze
in termini di operazioni interne, e una che descrive l'evoluzione del sistema
