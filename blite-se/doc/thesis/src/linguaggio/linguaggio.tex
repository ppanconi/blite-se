...
\xinstnostate{\xsigma}{\xskip} 
  ...
  \item[\rulelabel{$\xdl_2$}] In uno scope in cui la contest activity giunge ad 
  $\xstop$ a causa di una eccezione o di una richiesta di terminazione,
  attraverso un transizione interna si attiva l'esecuzione protetta di
  compensation handler istallati e del fault handler.
...
comunicazione all'interno di sistemi di deployment.
