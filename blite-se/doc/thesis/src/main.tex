...
\AtBeginDocument{\renewcommand{\bibname}{Riferimenti}}
...
co-min-cias-se a-spet-ti si-mu-la-re se-con-do an-dia-mo sta-ti-ca con-si-de-ra
clien-ti com-ples-si-vo mo-der-ni se-con-da sup-por-ta-ti back-end}
\sloppy
...
{\clearpage{\pagestyle{empty}\cleardoublepage}
	\pagestyle{empty}
		...
		\begin{large}
			\begin{flushright}
				\emph{``A mio padre, a Valeria, presto mia moglie\\ e soprattutto a mia madre''}
		  \end{flushright}
		\end{large}
		\vfil\vfil\clearpage{\pagestyle{empty}\cleardoublepage}
}
