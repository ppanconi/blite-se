...
l'attribuzione del messaggio. Di fatto in una architettura come la nostra, 
che usa una tecnologia di \emph{multithreading} per realizzare la non sequezialità specificata dalla semantica di Blite, non ha molto
senso parlare di attività di ricezione che contemporaneamente attivie su una
porta. In pratica quando il flusso di escuzione di una istanza arriva ad
eseguire un ricezione su una determinata porta si deve poter decidere se un
messaggio associato alla porta è destinabile a tale istanza solamente in base
allo stato dell'istanza stessa. 
...
le semtica formale di 

% -con l'eccezione delle \emph{multiple
% start activity}\footnote{Con il termine \emph{multiple
% start activity}} per cui 
