...
Quello che abbiamo fatto è stato di introduure per ogni operatore un coppia di
...
fra gli operatori. In questo modo il codice stesso esplicità tutte le relazioni
di sequenzilità fra le diverse attività strutturate, e l'utilizzatore non sarà
...
da noi implemetata corrispondente al termine seguente
