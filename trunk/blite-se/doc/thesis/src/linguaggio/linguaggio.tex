...
\end{small}
  \vspace*{-1.20cm}
  \caption{Regole di riduzione per i deployment 
  (si consideri $\talpha_1 = \xapp{\plrec}{\xapp{\xo}{\bar{\xx}}}$ e 
  \mbox{$\talpha_2 =
...
\end{small}
  \vspace*{-1.20cm}
  \caption{Definizione del predicato
  $\xnoCONF{\xcorr}{\xI}{\xapp{\tilde{\xp}\,}{\xapp{\,\xo\,}{\,\bar{\xv}}}}{\xnum}$. 
...
\begin{description}
\item[\rulelabel{$\x{com}$}] Afferma che la comunicazione da \ldots verso \ldots 
 può avvenire solo se si realizza il matching, in rispetto dello stato di
 correlazione, dei valori del messaggio con le variabili di ricezione.
 ...
 processo a partire dalla definizione \ldots a seguito dell'arrivo di un
 messaggio \ldots che risulti in matching con una delle start activity della
 ...
 l'evoluzione parallela di un sistema di deployment, l'eseguzione
