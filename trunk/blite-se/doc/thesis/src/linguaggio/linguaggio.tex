...
Semplificando, per valutare se un messaggio può essere attribuito ad
un'istanza che esegue l'operazione $\xrec{\arr{\x{p}}}{\x{o}}{\bar{\xx}}$, si può attuare la seguente
procedura:
