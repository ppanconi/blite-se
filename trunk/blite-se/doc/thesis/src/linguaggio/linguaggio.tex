...
attivate, cioè si siano registrate come in attesa sulle rispettive porte. 
Solo dopo questo tornerà a gestire altri messaggi in arrivo.
In questo modo si realizza l'atomicità del passo descritto dalle regola (new),
...
fase sono state presentate per illustrare com processo di interpretazione della
sematica abbia
