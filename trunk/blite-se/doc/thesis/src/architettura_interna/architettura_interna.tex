...
individuata nel \icode{ExecutionContext}, la cui interfaccia a gia' piu' volte
...
\icode{ActivityComponentFactory}. Di fatti ogni oggetto ActivityComponent
...
dalla Figura \ref{fig:cntxclass}: \icode{ProcessInstanceImp},
\icode{ScopeActivity} e \icode{ProtecedScope}. Dinfatti ogni istanza di processo
